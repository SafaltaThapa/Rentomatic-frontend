    ...
    <>
        ...
        <div className="card-1">
          ...
          <div className="card-bottom">
            <div className="btndiv">
              <button onClick={() => setOpened(true)} className="btns">
                List Your Rooms
              </button>
      ...
      <div className="hero-section-2">
        ...
        <div className="hero-section-2-card">
          <div className="card">
            ...
            <span>
              Post available rooms with details and find tenants easily
            </span>
          </div>
          <div className="card">
          ...
          <div className="card">
            ...
            <h5>Quick contact</h5>
            <span>
              Find preferred rooms or tenants and contact easily to rent.
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="hero-section-3">
        ...
        >
          ...
          >
            <div className="title-hero-section-3-card">Bhaktapur</div>
            <img src={Bhaktapur} />
          </div>
          <div
            className="hero-section-3-card"
          ...
          >
            <div className="title-hero-section-3-card">Baneshor</div>
            <img src={Baneshor} />
          </div>
          <div
            className="hero-section-3-card"
          ...
          >
            <div className="title-hero-section-3-card">Pepsicola</div>
            <img src={Pepsicola} />
          </div>
          <div
            className="hero-section-3-card"
